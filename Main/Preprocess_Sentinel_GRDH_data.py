...
def Sigma0_FF_2_gtif(new_dir, Sigma0_directory, granule):
    ...
    cmd_VV = 'C:/Users/clayc/anaconda3/envs/Rasterio_Base/Lib/site-packages/osgeo/gdal_translate.exe -of GTiff ' + Sigma0_VV_path + ' ' + Sigma0_VV_save
    cmd_VH = 'C:/Users/clayc/anaconda3/envs/Rasterio_Base/Lib/site-packages/osgeo/gdal_translate.exe -of GTiff ' + Sigma0_VH_path + ' ' + Sigma0_VH_save
    print(cmd_VV)
    print(cmd_VH)
